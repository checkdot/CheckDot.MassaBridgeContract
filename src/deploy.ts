    ...
    [
      {
        ...
        args: new Args()
          .addString('BSC')
          .addString('AS12jyar7DLYxX9fsr1WsTkhMcZEvLSmHFQ1ucqWv2M1wqh7yv7zB')
          .addU64(10n)
          .addU64(10n)
          .addString('AS12WuMr6jLBy6xgPLSBZaypHC9BXtYBFG2Ys6fPQcEYTMBhSzofC')
          .addString('AS1Da3TdokuAwRFPuhs56X9MEZXLyjiMtZtevZU9SVTLE7BbjKX2')
          .addString('AS12SyYeTmBFJgBGZup7m9DZ1gV4HPTmZRthDRihDfDzfsJ7HLk7m'), // arguments for deployment
      } as ISCData,
